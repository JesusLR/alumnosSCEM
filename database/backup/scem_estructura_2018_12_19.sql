...
--
-- Servidor: localhost
-- Tiempo de generación: 19-12-2018 a las 16:19:06
...
CREATE TABLE `empleados` (
  ...
  `persona_id` bigint(255) UNSIGNED NOT NULL,
  `escuela_id` bigint(255) UNSIGNED DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `empleados_escuela`
--

CREATE TABLE `empleados_escuela` (
...
ALTER TABLE `alumnos`
  ...
  ADD KEY `idx_alumno_aluClave` (`aluClave`);
...
ALTER TABLE `edocta`
  ...
  ADD KEY `idx_edocta_estado` (`edoEstado`),
  ADD KEY `idx_edocta_claveAlu` (`edoClaveAlu`),
  ADD KEY `i_cvemesdig` (`edoClaveAlu`,`edoMesPago`,`edoDigPago`),
  ADD KEY `i_fecoper` (`edoFechaOper`);
...
--
-- Indices de la tabla `empleados_escuela`
--
ALTER TABLE `empleados_escuela`
...
ALTER TABLE `fichas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ficha_aluClave` (`fchClaveAlu`);
...
ALTER TABLE `pagos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_pagos_claveAlu` (`pagClaveAlu`),
  ADD KEY `idx_pagos_estado` (`pagEstado`),
  ADD KEY `i_conc` (`pagConcPago`),
  ADD KEY `i_pag_dup` (`pagClaveAlu`,`pagAnioPer`,`pagConcPago`),
  ADD KEY `i_usua_pag` (`usuario_at`);
...
ALTER TABLE `referencias`
  ...
  ADD KEY `i_clave_pago_ref` (`alumno_id`);
