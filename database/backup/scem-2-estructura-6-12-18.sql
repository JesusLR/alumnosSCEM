...
--
-- Servidor: localhost
-- Tiempo de generación: 05-12-2018 a las 22:12:17
...
ALTER TABLE `usuaGim`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_gim_alumno_idx` (`alumno_id`);
...
--
ALTER TABLE `usuaGim`
  ADD CONSTRAINT `fk_gim_alumno` FOREIGN KEY (`alumno_id`) REFERENCES `alumnos` (`id`) ON UPDATE CASCADE;
COMMIT;
