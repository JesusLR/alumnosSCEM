...
--
-- Servidor: localhost
-- Tiempo de generación: 17-10-2018 a las 18:45:26
...
INSERT INTO `departamentos` (`id`, `ubicacion_id`, `depNivel`, `depClave`, `depNombre`, `depNombreCorto`, `depClaveOficial`, `depNombreOficial`, `perActual`, `perAnte`, `perSig`, `depCalMinAprob`, `depCupoGpo`, `depTituloDoc`, `depNombreDoc`, `depPuestoDoc`, `depIncorporadoA`, `usuario_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
(2, 1, 5, 'SUP', 'SUPERIOR', 'SUPERIOR', NULL, NULL, 6, 1, 7, 60, 30, NULL, NULL, NULL, NULL, 23, NULL, NULL, NULL);
...
INSERT INTO `ubicacion` (`id`, `ubiClave`, `ubiNombre`, `ubiCalle`, `ubiCol`, `ubiCP`, `ubiPob`, `ubiEdo`, `usuario_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'CME', 'CAMPUS MERIDA CHOLUL', NULL, NULL, NULL, 'Mérida', 'Yucatán', 23, NULL, NULL, NULL),
(2, 'CVA', 'CAMPUS VALLADOLID', NULL, NULL, NULL, 'Valladolid', 'Yucatán', 23, NULL, NULL, NULL),
(3, 'CCH', 'CAMPUS CHETUMAL', NULL, NULL, NULL, 'Chetumal', 'Quintana Roo', 23, NULL, NULL, NULL),
(4, 'CMO', 'CAMPUS MERIDA PASEO MONTEJO', NULL, NULL, NULL, 'Mérida', 'Yucatán', 23, NULL, NULL, NULL);
