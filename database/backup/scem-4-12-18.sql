...
--
-- Servidor: localhost
-- Tiempo de generación: 04-12-2018 a las 14:53:49
...
INSERT INTO `grupos` (`id`, `materia_id`, `periodo_id`, `gpoSemestre`, `gpoClave`, `gpoTurno`, `empleado_id`, `empleado_sinodal_id`, `gpoMatClaveComplementaria`, `gpoFechaExamenOrdinario`, `gpoHoraExamenOrdinario`, `gpoCupo`, `gpoNumeroFolio`, `gpoNumeroActa`, `gpoNumeroLibro`, `grupo_equivalente_id`, `optativa_id`, `estado_act`, `fecha_mov_ord_act`, `clave_actv`, `usuario_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 3, 1, 'A', 'M', 2, 2, NULL, '2018-11-06', '10:00:00', 45, NULL, NULL, NULL, NULL, NULL, 'C', NULL, NULL, 1, '2018-11-12 22:12:16', '2018-11-12 22:12:16', NULL),
(2, 2, 3, 1, 'A', 'M', 2, 2, NULL, '2018-11-07', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'C', NULL, NULL, 1, '2018-11-12 22:50:10', '2018-11-12 23:23:28', NULL),
(3, 5, 3, 1, 'EXX', 'M', 1, NULL, NULL, NULL, NULL, 40, NULL, NULL, NULL, NULL, NULL, 'B', NULL, NULL, 1, '2018-11-13 00:42:45', '2018-11-30 22:48:21', NULL),
(4, 5, 3, 1, 'B', 'M', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'C', NULL, NULL, 1, '2018-11-13 19:57:38', '2018-11-27 21:04:04', NULL);
...
ALTER TABLE `grupos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_grupo_unico` (`materia_id`,`periodo_id`,`gpoSemestre`,`gpoClave`,`gpoTurno`,`deleted_at`),
