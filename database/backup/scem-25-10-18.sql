...
--
-- Servidor: localhost
-- Tiempo de generación: 25-10-2018 a las 21:14:58
...
(1, 1, 'CCO', 'CENTRO DE COMPUTO', 'CENTRO DE COMPU', '70.00', '30.00', 0, NULL, NULL, NULL);
...
--
ALTER TABLE `empleados`
  MODIFY `id` bigint(255) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Identificador del empleado', AUTO_INCREMENT=2;
