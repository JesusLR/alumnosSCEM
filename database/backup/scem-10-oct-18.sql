...
--
-- Servidor: localhost
-- Tiempo de generación: 11-10-2018 a las 20:36:25
...
CREATE DEFINER=`scem_admin`@`%` PROCEDURE `insertarAlumno` (`iaCurp` CHAR(18), `iaApellido1` CHAR(30), `iaApellido2` CHAR(30), `iaNombre` CHAR(40), `iaFechaNac` DATE, `iaMunicipio` SMALLINT(6), `iaSexo` CHAR(1), `iaCorreo1` CHAR(60), `iaTelefono1` CHAR(10), `iaTelefono2` CHAR(10), `iaDirCp` INT(5), `iaDirCalle` CHAR(25), `iaDirNumInt` CHAR(6), `iaDirNumExt` CHAR(6), `iaDirColonia` CHAR(60), `iaUsuaProc` CHAR(15), `iaClave` INT(8), `iaNivelIngr` INT(1), `iaGradoIngr` INT(1))  BEGIN
INSERT INTO `SCEM`.`personas`
(
	`perCurp`,
	`perApellido1`,
	`perApellido2`,
...
CREATE TABLE `alumnos` (
  ...
  `aluUsuaProc` varchar(15) DEFAULT NULL COMMENT 'Usuario que hizo el último cambio',
  `aluFechaProc` timestamp NULL DEFAULT NULL COMMENT 'Fecha del último cambio'
...
INSERT INTO `alumnos` (`id`, `persona_id`, `aluClave`, `aluEstado`, `aluFechaIngr`, `aluNivelIngr`, `aluGradoIngr`, `aluMatricula`, `aluUsuaProc`, `aluFechaProc`) VALUES
(2, 1, 11990032, 'P', '0000-00-00 00:00:00', 0, 0, NULL, NULL, NULL);
...
(1, 1, '201', 20, 'EJEMPLO DE DESCRIPCIÓN DE AULA', 'PLANTA BAJA', 20, NULL, NULL, NULL),
(3, 1, '110', 30, '', '', 20, NULL, NULL, NULL);
...
(4, 2, 1, 1, 'A', 'M', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20, NULL, NULL, NULL),
...
(1, 'D', 2, 2018, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '6400.00', '2018-05-05', '7400.00', '2018-07-10', NULL, NULL, NULL, '0679569', 0, NULL, NULL, NULL);
...
(4, 2, 4, '', NULL, '', NULL, NULL, 'A', 'RE', NULL, NULL, NULL, NULL, NULL, '', 'N', NULL, 20, NULL, NULL, NULL),
(5, 2, 5, '', NULL, '', NULL, NULL, 'A', 'PI', NULL, NULL, NULL, NULL, NULL, '', 'N', NULL, 20, NULL, NULL, NULL);
...
INSERT INTO `departamentos` (`id`, `ubicacion_id`, `depNivel`, `depClave`, `depNombre`, `depNombreCorto`, `depClaveOficial`, `depNombreOficial`, `perActual`, `perAnte`, `perSig`, `depCalMinAprob`, `depCupoGpo`, `depTituloDoc`, `depNombreDoc`, `depPuestoDoc`, `depIncorporadoA`) VALUES
(2, 1, 5, 'SUP', 'SUPERIOR', 'SUPERIOR', NULL, NULL, 6, 1, 7, 60, 30, NULL, NULL, NULL, NULL);
...
CREATE TABLE `empleados` (
  ...
  `empRfc` varchar(11) DEFAULT '' COMMENT 'RFC del empleado',
  `empImss` varchar(11) DEFAULT '' COMMENT 'Número de IMSS',
  `empHorasCon` int(11) DEFAULT '0',
  `empEstado` enum('A','B') NOT NULL DEFAULT 'A' COMMENT 'Estado del empleado Alta o Baja',
  `empHoraProc` time NOT NULL,
  `empFechaProc` date NOT NULL,
  `empUsuaProc` varchar(15) NOT NULL,
...
INSERT INTO `empleados` (`id`, `persona_id`, `escuela_id`, `empPassword`, `empCredencial`, `empNomina`, `empRfc`, `empImss`, `empHorasCon`, `empEstado`, `empHoraProc`, `empFechaProc`, `empUsuaProc`, `empFechaBaja`, `empCausaBaja`) VALUES
(1, 1, 2, NULL, '11990032', 0, '', '', 0, 'A', '00:00:00', '0000-00-00', '', NULL, ''),
(3, 2, 2, NULL, '11990034', 3434, '34233434', '', 0, 'A', '00:00:00', '0000-00-00', '', NULL, '');
...
INSERT INTO `escuelas` (`id`, `departamento_id`, `escClave`, `escNombre`, `escNombreCorto`, `escPorcExaPar`, `escPorcExaOrd`) VALUES
(2, 2, 'ADI', 'ACADEMIA DE INGLES', 'ACADEMIA DE ING', '70.00', '30.00');
...
INSERT INTO `estados` (`id`, `pais_id`, `edoNombre`, `edoAbrevia`, `edoRenapo`, `edoISO`) VALUES
(1, 1, 'Aguascalientes', 'Ags.', '', 'AGU'),
(2, 1, 'Baja California', 'B.C.', '', 'BCN'),
(3, 1, 'Baja California Sur', 'B.C.S.', '', 'BCS'),
(4, 1, 'Campeche', 'Camp.', '', 'CAM'),
(5, 1, 'Chiapas', 'Chis.', '', 'CHP'),
(6, 1, 'Chihuahua', 'Chih.', '', 'CHH'),
(7, 1, 'Coahuila', 'Coah.', '', 'COA'),
(8, 1, 'Colima', 'Col.', '', 'COL'),
(9, 1, 'Ciudad de México', 'D.F.', '', 'CMX'),
(10, 1, 'Durango', 'Dgo.', '', 'DUR'),
(11, 1, 'Guanajuato', 'Gto.', '', 'GUA'),
(12, 1, 'Guerrero', 'Gro.', '', 'GRO'),
(13, 1, 'Hidalgo', 'Hgo.', '', 'HID'),
(14, 1, 'Jalisco', 'Jal.', '', 'JAL'),
(15, 1, 'Estado de México', 'Edo. Méx.', '', 'MEX'),
(16, 1, 'Michoacán', 'Mich.', '', 'MIC'),
(17, 1, 'Morelos', 'Mor.', '', 'MOR'),
(18, 1, 'Nayarit', 'Nay.', '', 'NAY'),
(19, 1, 'Nuevo León', 'N.L.', '', 'NLE'),
(20, 1, 'Oaxaca', 'Oax.', '', 'OAX'),
(21, 1, 'Puebla', 'Pue.', '', 'PUE'),
(22, 1, 'Querétaro', 'Qro.', '', 'QUE'),
(23, 1, 'Quintana Roo', 'Q. Roo.', '', 'ROO'),
(24, 1, 'San Luis Potosí', 'S.L.P.', '', 'SLP'),
(25, 1, 'Sinaloa', 'Sin.', '', 'SIN'),
(26, 1, 'Sonora', 'Son.', '', 'SON'),
(27, 1, 'Tabasco', 'Tab.', '', 'TAB'),
(28, 1, 'Tamaulipas', 'Tamps.', '', 'TAM'),
(29, 1, 'Tlaxcala', 'Tlax.', '', 'TLA'),
(30, 1, 'Veracruz', 'Ver.', '', 'VER'),
(31, 1, 'Yucatán', 'Yuc.', '', 'YUC'),
(32, 1, 'Zacatecas', 'Zac.', '', 'ZAC'),
(33, 1, 'California', 'CA', '', 'CA'),
(34, 1, 'Pernambuco', 'PE', '', 'PE'),
(35, 1, 'Distrito de Belice', 'DB', '', 'DB');
...
CREATE TABLE `grupos` (
  ...
  `usuario_at` bigint(255) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(8, 4, 4, 1, 1, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 20, NULL, NULL, NULL),
(11, 5, 4, 1, 1, '', NULL, NULL, NULL, '', '', '', NULL, '', 20, NULL, NULL, NULL),
(12, 6, 4, 3, 3, '', NULL, NULL, 20, '', '', '', NULL, '', 20, NULL, NULL, NULL),
(13, 7, 5, 3, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `horarios` (`id`, `grupo_id`, `aula_id`, `ghDia`, `ghInicio`, `ghFinal`, `created_at`, `updated_at`, `deleted_at`) VALUES
(5, 8, 1, 1, 9, 12, '2018-09-24 23:29:02', '2018-09-24 23:29:02', NULL),
(6, 12, 3, 1, 8, 12, '2018-09-25 00:29:19', '2018-09-25 00:29:19', NULL);
...
CREATE TABLE `inscritos` (
  ...
  `usuario_at` int(10) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(6, 4, 8, NULL, NULL, NULL, '2018-10-02 00:56:21', '2018-10-02 00:56:21', NULL),
(10, 5, 11, NULL, NULL, NULL, '2018-10-08 23:47:15', '2018-10-08 23:47:15', NULL),
(11, 5, 13, NULL, NULL, NULL, '2018-10-08 23:47:15', '2018-10-08 23:47:15', NULL);
...
INSERT INTO `materias` (`id`, `plan_id`, `matClave`, `matNombre`, `matNombreCorto`, `matSemestre`, `matCreditos`, `matClasificacion`, `matEspecialidad`, `matTipoAcreditacion`, `matPorcentajeParcial`, `matPorcentajeOrdinario`, `matNombreOficial`, `matClaveEquivalente`) VALUES
(4, 2, '1111', 'ADMINISTRACION I', 'ADMINISTRACION ', 1, 8, 'B', NULL, 'N', NULL, NULL, NULL, NULL),
(5, 2, '222', 'ADMINISTRACION 2', 'ADMINISTRACION', NULL, NULL, 'B', NULL, 'N', NULL, NULL, NULL, NULL);
...
INSERT INTO `municipios` (`id`, `estado_id`, `munNombre`) VALUES
(7, 31, 'Mérida');
...
INSERT INTO `paises` (`id`, `paisNombre`, `paisAbrevia`) VALUES
(1, 'México', 'MEX'),
(2, 'Estados Unidos de América', 'EEUU'),
(3, 'Brasil', 'BRA'),
(4, 'Belice', 'BEL');
...
(3, 6, 2, 1, 1, 20, '2018-09-26 21:42:33', '2018-09-26 21:42:33', NULL),
(4, 6, 2, 1, 2, 20, '2018-09-28 20:52:44', '2018-09-28 20:52:44', NULL);
...
INSERT INTO `paquete_detalle` (`id`, `paquete_id`, `grupo_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 3, 11, '2018-09-26 21:42:33', '2018-09-26 21:42:33', NULL),
(2, 3, 13, '2018-09-26 21:42:33', '2018-09-26 21:42:33', NULL),
(3, 4, 11, '2018-09-28 20:52:44', '2018-09-28 20:52:44', NULL),
(4, 4, 13, '2018-09-28 20:52:44', '2018-09-28 20:52:44', NULL);
...
INSERT INTO `periodos` (`id`, `departamento_id`, `perNumero`, `perAnio`, `perFechaInicial`, `perFechaFinal`, `perEstado`) VALUES
(1, 2, 1, 2018, '2018-01-01', '2018-07-31', NULL),
(6, 2, 3, 2018, '2018-08-01', '2018-12-31', NULL),
(7, 2, 2, 2019, '2019-01-01', '2019-07-31', NULL);
...
(15, 1, 1, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(16, 1, 2, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(17, 1, 3, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(18, 1, 4, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(19, 1, 5, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(20, 1, 6, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(21, 1, 7, 20, '2018-09-03 20:34:58', '2018-09-03 20:34:58'),
(22, 4, 1, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(23, 4, 2, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(24, 4, 3, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(25, 4, 4, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(26, 4, 5, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(27, 4, 6, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(28, 4, 7, 23, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(29, 1, 8, 20, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(46, 1, 9, 20, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(47, 1, 10, 20, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(48, 1, 11, 20, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(49, 1, 12, 20, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(50, 1, 13, 20, '2018-09-10 18:55:49', '2018-09-10 18:55:49'),
(51, 1, 14, 20, '2018-09-10 18:55:49', '2018-09-01 00:29:46'),
(52, 1, 15, 20, '2018-09-01 00:29:46', '2018-09-01 00:29:46'),
(53, 1, 16, 20, '2018-09-01 00:29:46', '2018-09-01 00:29:46'),
(54, 1, 17, 20, '2018-09-01 00:29:46', '2018-09-01 00:29:46'),
(55, 1, 18, 20, '2018-09-01 00:29:46', '2018-09-01 00:29:46');
...
CREATE TABLE `personas` (
  ...
  `perDirNumInt` varchar(6) NOT NULL COMMENT 'Dirección: Número interior',
  `perDirNumExt` varchar(6) DEFAULT NULL COMMENT 'Dirección: Número exterior',
  `perDirColonia` varchar(60) NOT NULL,
  `perTipoSangre` enum('O+','O-','A+','A-','B+','B-','AB+','AB-') NOT NULL COMMENT 'Tipo de Sangre',
  `perUsuaProc` varchar(15) DEFAULT NULL COMMENT 'Usuario que hizo el último cambio',
  `perFechaProc` timestamp NULL DEFAULT NULL COMMENT 'Fecha del último cambio'
...
INSERT INTO `personas` (`id`, `perCurp`, `perApellido1`, `perApellido2`, `perNombre`, `perFechaNac`, `municipio_id`, `perSexo`, `perCorreo1`, `perTelefono1`, `perTelefono2`, `perDirCP`, `perDirCalle`, `perDirNumInt`, `perDirNumExt`, `perDirColonia`, `perTipoSangre`, `perUsuaProc`, `perFechaProc`) VALUES
(1, 'DFDGDFDF', 'paredes', 'moreno', 'ismael', '0000-00-00', 50, 'M', NULL, NULL, NULL, 97000, '', '', NULL, '', 'O+', 'luislara', NULL),
(2, '', 'lara', 'poot', 'luis', '0000-00-00', 0, 'F', NULL, NULL, NULL, 0, '', '', NULL, '', 'O+', NULL, NULL);
...
INSERT INTO `planes` (`id`, `programa_id`, `planClave`, `planPeriodos`) VALUES
(2, 2, '2017', 8);
...
INSERT INTO `programas` (`id`, `escuela_id`, `progClave`, `progNombre`, `progNombreCorto`, `progClaveSegey`, `progClaveEgre`, `progTituloOficial`) VALUES
(2, 2, 'ADE', 'ADMINISTRACION Y DESARROLLO EMPRESARIAL', 'ADMINISTRACION ', NULL, NULL, NULL);
...
CREATE TABLE `ubicacion` (
  ...
  `ubiCol` varchar(30) DEFAULT NULL COMMENT 'Colonia',
  `ubiCP` varchar(30) DEFAULT NULL COMMENT 'Código Postal',
  `ubiPob` varchar(30) DEFAULT NULL COMMENT 'Población',
  `ubiEdo` varchar(30) DEFAULT NULL COMMENT 'Estado'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `ubicacion` (`id`, `ubiClave`, `ubiNombre`, `ubiCalle`, `ubiCol`, `ubiCP`, `ubiPob`, `ubiEdo`) VALUES
(1, 'CME', 'CAMPUS MERIDA CHOLUL', NULL, NULL, NULL, 'Mérida', 'Yucatán'),
(2, 'CVA', 'CAMPUS VALLADOLID', NULL, NULL, NULL, 'Valladolid', 'Yucatán'),
(3, 'CCH', 'CAMPUS CHETUMAL', NULL, NULL, NULL, 'Chetumal', 'Quintana Roo'),
(4, 'CMO', 'CAMPUS MERIDA PASEO MONTEJO', NULL, NULL, NULL, 'Mérida', 'Yucatán');
...
(20, 1, 'ismael', '$2y$10$GoOSayVJErCGEWWt22cXtOcY30Jx/4MaHH3Eo5Vc8.bJLv0ZQftqe', 'Q5f1Sfj4jwCXiTSJekO0oingGtfYmkf0Io709o6ZiQfFSNrRTh6bh1R9e7uj', '7kRk0D2PGaDQ5z8B4ucNO5pMJCHMkYBTxXnmyVD9uGTN4S162FzObNZX2GZQMR2E', '2018-09-03 20:34:13', '2018-09-03 20:34:13', NULL),
(23, 1, 'isma', '$2y$10$gbtZqFVbUVtd9tCjvKxldOBmbmaBhe7uWQOZ3X2iKvrGrsPxIUscm', 'HubBNPOaF846XSXrdKP5PMS9uqYHHhJHiUvcwP9NmKL2mbaFxvQexpKS2L5g', 'ZElz0Dhm6fmVqJVPkxwuZuTAZ1t9vMwAb06djzueyIQWcdjNrntbANKzLfl54kDl', '2018-09-10 18:55:49', '2018-09-10 22:17:35', '2018-09-10 22:17:35');
...
ALTER TABLE `historico`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_historico_curso_idx` (`curso_id`),
  ADD KEY `fk_historico_grupo_idx` (`grupo_id`);
...
--
ALTER TABLE `ubicacion`
  MODIFY `id` bigint(255) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'identificador Numérico', AUTO_INCREMENT=5;
...
--
ALTER TABLE `historico`
  ADD CONSTRAINT `fk_historico_curso` FOREIGN KEY (`curso_id`) REFERENCES `cursos` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_historico_grupo` FOREIGN KEY (`grupo_id`) REFERENCES `grupos` (`id`) ON UPDATE CASCADE;
