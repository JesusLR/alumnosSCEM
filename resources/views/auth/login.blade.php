            ...
            <div class="col s12 m8 l6 xl4">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <span class="card-title center-align">SERVICIOS</span>
                        <span class="card-title center-align">ESCOLARES</span>
                    </div>
                    <div class="row">
                        <div class="col s1"></div>
                        <div class="input-field col s10 {{ $errors->has('username') ? 'is-invalid' :'' }}">
                            <i class="material-icons prefix">person</i>
                            {!! Form::text('username', null, array('id' => 'username', 'class' => 'validate', 'maxlength'=>'50' )) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s10 {{ $errors->has('password') ? 'is-invalid' :'' }}">
                            ...
                            {!! Form::password('password', array('id' => 'userpass', 'class' => 'validate', 'maxlength'=>'50' )) !!}
