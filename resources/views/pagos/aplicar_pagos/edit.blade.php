            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <div class="input-field">
                  {!! Form::text('pagClaveAlu', $pago->pagClaveAlu, array('id' => 'pagClaveAlu', 'class' => 'validate','required','maxlength'=>'40')) !!}
              ...
              <div class="col s12 m6 l4">
                <div class="input-field">
                  {!! Form::number('pagAnioPer', $pago->pagAnioPer, [
                    'id' => 'pagAnioPer', 'class' => 'validate','required',
              ...
              <div class="col s12 m6 l4">
                ...
                <select id="pagConcPago" class="browser-default validate select2" required name="pagConcPago" style="width: 100%;">
                    <option value="" disabled>SELECCIONE UNA OPCIÓN</option>
                    @foreach($conceptosPago as $concepto)
                        <option
                          {{$pago->pagConcPago == $concepto->conpClave ? "selected": ""}}
                          value="{{$concepto->conpClave}}">{{$concepto->conpClave}} {{$concepto->conpNombre}}
                        </option>
                    @endforeach
                </select>
              </div>
