...
@section('breadcrumbs')
    ...
    <a href="{{url('ordinarios/'.$alumno->id)}}" class="breadcrumb">Pagos del alumno</a>
@endsection

@section('content')

<div id="table-datatables">
    <h4 class="header">Ordinarios del alumno</h4>
