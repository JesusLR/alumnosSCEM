...
@section('breadcrumbs')
    ...
    <a href="{{url('horario')}}" class="breadcrumb">Extraordinarios del alumno</a>
@endsection

@section('content')

<div id="table-datatables">
    <h4 class="header">Extraordinarios del alumno</h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-pagos').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/extraordinarios/",
                beforeSend: function () {
