                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <div class="col s12 m6 l6">
                            ...
                            <input type="date" value="{{$calendario->calexInicioParcial1}}" name="calexInicioParcial1" id="calexInicioParcial1">
                        </div>
                        <div class="col s12 m6 l6">
                            {!! Form::label('calexFinParcial1', 'Fecha final', array('class'=>'')) !!}
                            <input type="date" value="{{$calendario->calexFinParcial1}}" name="calexFinParcial1" id="calexFinParcial1">
                        </div>
                    </div>
                    <div class="col s12 m6 l4">
                        <div class="row" style="background-color:#ECECEC;margin-right:3px;">
                        ...
                        <div class="col s12 m6 l6">
                            ...
                            <input type="date" value="{{$calendario->calexInicioParcial2}}" name="calexInicioParcial2" id="calexInicioParcial2">
                        </div>
                        <div class="col s12 m6 l6">
                            {!! Form::label('calexFinParcial2', 'Fecha final', array('class'=>'')) !!}
                            <input type="date" value="{{$calendario->calexFinParcial2}}" name="calexFinParcial2" id="calexFinParcial2">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <div class="col s12 m6 l6">
                            ...
                            <input type="date" value="{{$calendario->calexInicioParcial3}}" name="calexInicioParcial3" id="calexInicioParcial3">
                        </div>
                        <div class="col s12 m6 l6">
                            {!! Form::label('calexFinParcial3', 'Fecha final', array('class'=>'')) !!}
                            <input type="date" value="{{$calendario->calexFinParcial3}}" name="calexFinParcial3" id="calexFinParcial3">
                        </div>
                    </div>
                    <div class="col s12 m6 l4">
                        <div class="row" style="background-color:#ECECEC;margin-right:3px;">
                        ...
                        <div class="col s12 m6 l6">
                            ...
                            <input type="date" value="{{$calendario->calexInicioOrdinario}}" name="calexInicioOrdinario" id="calexInicioOrdinario">
                        </div>
                        <div class="col s12 m6 l6">
                            {!! Form::label('calexFinOrdinario', 'Fecha final', array('class'=>'')) !!}
                            <input type="date" value="{{$calendario->calexFinOrdinario}}" name="calexFinOrdinario" id="calexFinOrdinario">
                        </div>
                    </div>
                </div>
