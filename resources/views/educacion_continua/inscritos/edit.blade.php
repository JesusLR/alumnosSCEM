            ...
            <div id="general">
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  ...
                  {!! Form::date('ecFechaRegistro', NULL, array('id' => 'ecFechaRegistro', 'class' => 'validate','required')) !!}
                </div>
              </div>
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  ...
                  <select id="ecCoordinador_empleado_id" class="browser-default validate select2" required name="ecCoordinador_empleado_id" style="width: 100%;">
                    <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                ...
                <div class="col s12 m6 l4">
                  ...
                  <select id="ecInstructor1_empleado_id" class="browser-default validate select2" required name="ecInstructor1_empleado_id" style="width: 100%;">
                    <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                    @foreach($empleados as $empleado)
                      <option value="{{$empleado->id}}">
                        {{$empleado->persona->perNombre . " " . $empleado->persona->perApellido1 . " " . $empleado->persona->perApellido2}}
                ...
                <div class="col s12 m6 l4">
                  ...
                  <select id="ecInstructor2_empleado_id" class="browser-default validate select2" required name="ecInstructor2_empleado_id" style="width: 100%;">
                    <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                    @foreach($empleados as $empleado)
                      <option value="{{$empleado->id}}">
                        {{$empleado->persona->perNombre . " " . $empleado->persona->perApellido1 . " " . $empleado->persona->perApellido2}}
