                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <div class="row">
                            <div class="col s12 m6 l6">
                                <a class="waves-effect waves-light btn" href="https://consultas.curp.gob.mx/CurpSP/gobmx/inicio.jsp" target="_blank">
                                    Verificar Curp
                                </a>
                            </div>
                    ...
                    <div class="col s12 m6 l4">
                                ...
                                @foreach($departamentos as $departamento)
                                    @if($alumno->aluNivelIngr == $departamento->depNivel)
                                        <option value="{{$departamento->depNivel}}" >
                                            ...
                                            @if ($departamento->depClave == "PRE") Pre-primaria @endif
                                            @if ($departamento->depClave == "PRI") Primaria @endif
                                            @if ($departamento->depClave == "SEC") Secundaria @endif
                                            @if ($departamento->depClave == "ECO") Educación continua @endif
                                        </option>
                                    @endif
                                @endforeach
                            </select>
                        ...
                        <div class="input-field col s12 m6 l6">
                            {!! Form::number('aluGradoIngr', $alumno->aluGradoIngr, array('id' => 'aluGradoIngr', 'class' => 'validate','required','min'=>'0','max'=>'9999','onKeyPress="if(this.value.length==4) return false;"')) !!}
