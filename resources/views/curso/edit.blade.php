        ...
        <div class="card ">
          <div class="card-content ">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l4">
                    <div class="input-field">
                        {!! Form::number('curExani', $curso->curExani, ['id' => 'curExani', 'class' => 'validate','', 'min' => '950', 'max' => '1300']) !!}
            ...
            <div id="becas">
                ...
                <div class="row">
                    <div class="col s12 m8">
                        <div class="input-field">
                        {!! Form::textarea('curObservacionesBeca', $curso->curObservacionesBeca, ['id' => 'curObservacionesBeca', 'class' => 'materialize-textarea','rows' => 2, 'cols' => 40,'data-length' => "30"]) !!}
