...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'curso.store', 'method' => 'POST']) !!}
        <div class="card ">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            <div style="position:relative;">
                                ...
                                <input id="curExani" class="validate"  min="950" max="1300" name="curExani" type="number"
                                ...
                                {{--
                                {!! Form::number('curExani', isset($candidato) ? $candidato->curExani: null, array('id' => 'curExani', 'class' => 'validate','', 'min' => '950', 'max' => '1300')) !!}
                                --}}
                                @if (isset($candidato))
            ...
            <div id="becas">
                ...
                <div class="row">
                    <div class="col s12 m8">
                        <div class="input-field">
                        {!! Form::textarea('curObservacionesBeca', NULL, ['id' => 'curObservacionesBeca', 'class' => 'materialize-textarea','rows' => 2, 'cols' => 40,'data-length' => "30"]) !!}
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      if(departamento_id) {
        ...
        getPeriodos_afterDate(departamento_id, 'periodo_id', null, null, 'perActual');
      }
