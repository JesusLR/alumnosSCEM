...
@section('breadcrumbs')
    ...
    <a href="{{url('curso/' . $curso->id . '/historial_calificaciones_alumno')}}" class="breadcrumb">Historial de calificaciones</a>
@endsection
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var tableCurso = $('#tbl-calificaciones').dataTable({
      ...
      "ajax": {
        "type" : "GET",
        'url': base_url + '/api/curso/' + cursoId + '/listHistorialCalifAlumnos/',
        beforeSend: function () {
