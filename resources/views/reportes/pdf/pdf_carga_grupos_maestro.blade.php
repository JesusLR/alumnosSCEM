...
<html>
  ...
  <body>
      ...
      <div class="row">
        ...
        <div class="columns medium-6">
          <div style="text-align: right;">
            <p>{{$fechaActual}}</p>
            <p>{{$horaActual}}</p>
            <p>CargaGruposMaestroController</p>
          </div>
        </div>
      </div>
      <div class="row">
    ...
    @foreach ($datos as $datos)
       ...
       <tr>
        <td style="width: 400px;">
          ...
          <span style="font-weight: 400; display:inline-block; margin-top: 5px;">
            {{$maestro['nombreEmpleado']}}
          </span>
        </td>

        <td style="width: 40px;" align="center">{{$maestro['hrsContrato']}}</td>
        <td style="width: 40px;" align="center">{{$maestro['horasDocentes']}}</td>
        <td style="width: 35px;" align="center">{{$maestro['horasNoDocentes']}}</td>
        <td style="width: 20px;" align="center">{{$maestro['horasTotales']}}</td>
      ...
      $sumaHorasDocentes += $maestro['horasDocentes'];
      $sumaHorasNoDocentes += $maestro['horasNoDocentes'];
      $sumaHorasTotales += $maestro['horasTotales'];
      @endphp
            @if($tipoReporte == true)
                  ...
                  <tr>
                    <td style="width: 400px;">
                      ...
                      <span style="font-weight: 400; display:inline-block; width: 30px;">
                        ...
                        @endif
                        {{$materia['hrsGrupo'] ? $materia['hrsGrupo'] : 0}}
                      </span>
                      <span style="font-weight: 400; display:inline-block; width: 30px;">
                        @if ($loop->first)
