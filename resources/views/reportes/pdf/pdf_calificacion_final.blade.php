  ...
  <body>
    ...
    <div class="row">
      ...
      <p align="justify">{{$suscribe}} {{$firmante->firNombre}}, {{$firmante->firPuesto}}
         de la {{$depNombre}}, con Clave de Centro de Trabajo
         {{$depClaveOficial}}; hace constar que {{$joven}} joven {{$nombreCompleto}} es
        ...
        en el ciclo escolar del {{$cicloEscolar}} y ha obtenido en el último curso las siguientes calificaciones:</p>
          <br>
      <p align="justify">SEMESTRE: {{$cicloSemestre}}</p>
      @foreach ($materias as $materia)
      @php
        $matNombre = $materia['matNombre'];
        $matComplementoNombre = null;
        if($materia['histComplementoNombre']){
          $matComplementoNombre = ' - '.$materia['histComplementoNombre'];
        }
