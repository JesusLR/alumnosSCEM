  ...
  <body>
    <header>
      ...
      <div class="row" style="margin-bottom: 2px">
        <div class="columns medium-12">
            <p>Carrera: {{$programa->progClave}} ({{$plan->planClave}}) {{$programa->progNombre}}</p>
        </div>
      </div>
      <div class="row" style="margin-bottom: 2px;">
        <div class="columns medium-6">
          ...
          <table class="table">
            ...
            @foreach ($datos as $grado)
              @foreach ($grado as $alumno)
                ...
                @endphp
                <tr>
                  <td style="font-weight: 400; width: 5px;">{{$alumnoInfo['aluClave']}}</td>
                  <td style="font-weight: 400; width: 200px;">{{$alumnoInfo['nombre']}}</td>
                  <td align="center" style="font-weight: 400; width: 30px;">
                    {{$alumnoInfo['grado']}} {{$alumnoInfo['grupo']}}
                  </td>
                  <td colspan="5">&nbsp;</td>
                </tr>
                ...
                @foreach ($alumno as $materia)
                  @php
                    $histCalificacion = $materia['histCalificacion'];
                    if($histCalificacion) {
                  ...
                  <tr>
                    ...
                    <td>{{$materia['histPeriodoAcreditacion'] ?: '**'}}
                      <span style="margin-left: 6px;">
                        {{$materia['histTipoAcreditacion'] ?: ''}}
                      </span>
                    </td>
                    <td>
                      {{$materia['histFechaExamen'] ?: 'NO CURSADA'}}
                    </td>
                    <td>{{$histCalificacion ?: ''}}</td>
                  </tr>
