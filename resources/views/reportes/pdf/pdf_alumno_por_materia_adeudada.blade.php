          ...
          <table class="table">
            ...
            @foreach ($matSemestre as $materia)
              ...
              @foreach ($materia as $alumno)
                @php
                  $histCalificacion = $alumno['histCalificacion'];
                  if($histCalificacion) {
                ...
                <tr>
                  ...
                  <td>{{$alumno['histPeriodoAcreditacion'] ?: '**'}}
                    <span style="margin-left: 6px;">
                      {{$alumno['histTipoAcreditacion'] ?: ''}}
                    </span>
                  </td>
                  <td class="tcenter">{{$alumno['histFechaExamen'] ?: 'No cursada'}}</td>
                  <td class="tcenter">{{$histCalificacion ?: ''}}</td>
                </tr>
