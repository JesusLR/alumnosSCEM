...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Relación de Deudores de Colegiaturas (Lagunas)</a>
@endsection

@section('content')
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/relacion_deudores_lagunas/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Relación de Deudores de Colegiaturas (Lagunas)</span>
          {{-- NAVIGATION BAR--}}
                 ...
                 <div class="row">
                      <div class="col s12 m6 l4">
                          ...
                          <select name="tipoResumen" id="tipoResumen" class="browser-default validate select2" style="width: 100%;">
                              <option value="I">FECHAS DE PAGO CON CANTIDAD DE IMPORTE $</option>
                          </select>
                      </div>
                </div>
                 <div class="row">
