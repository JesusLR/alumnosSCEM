            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="iexTipoPago" class="browser-default validate select2" name="iexTipoPago" style="width: 100%;">
                            <option value="">SELECCIONE UNA OPCIÓN</option>
                            <option value="EFECTIVO" {{$solicitud->iexTipoPago == 'EFECTIVO' ? 'selected' : '' }}>EFECTIVO</option>
                            <option value="BANCO" {{$solicitud->iexTipoPago == 'BANCO' ? 'selected' : '' }}>BANCO</option>
                        </select>
                    </div>
                </div>
            </div>
