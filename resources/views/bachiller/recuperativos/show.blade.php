                ...
                <div class="row">                    
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraInicioLunes" id="extHoraInicioLunes" value="{{$extHoraInicioLunes.':'.$extMinutoInicioLunes}}" readonly>
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraFinLunes" id="extHoraFinLunes" value="{{$extHoraFinLunes.':'.$extMinutoFinLunes}}" readonly>
                ...
                <div class="row">                    
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraInicioMartes" id="extHoraInicioMartes" value="{{$extHoraInicioMartes.':'.$extMinutoInicioMartes}}" readonly>
                    </div>
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraFinMartes" id="extHoraFinMartes" value="{{$extHoraFinMartes.':'.$extMinutoFinMartes}}" readonly>
                ...
                <div class="row">                    
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraInicioMiercoles" id="extHoraInicioMiercoles" value="{{$extHoraInicioMiercoles.':'.$extMinutoInicioMiercoles}}" readonly>
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraFinMiercoles" id="extHoraFinMiercoles" value="{{$extHoraFinMiercoles.':'.$extMinutoFinMiercoles}}" readonly>
                    </div>
                    {{-- <div class="col s12 m6 l4">
                        <div class="input-field">
                ...
                <div class="row">                    
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraInicioJueves" id="extHoraInicioJueves" value="{{$extHoraInicioJueves.':'.$extMinutoInicioJueves}}" readonly>
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraFinJueves" id="extHoraFinJueves" value="{{$extHoraFinJueves.':'.$extMinutoFinJueves}}" readonly>
                ...
                <div class="row">                    
                    <div class="col s12 m6 l4">
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <input readonly type="time" name="extHoraInicioViernes" id="extHoraInicioViernes" value="{{$extHoraInicioViernes.':'.$extMinutoInicioViernes}}" readonly>
