...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Reporte alumnos inscritos a extraordinarios</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_recuperativos.generarReporte', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Reporte alumnos inscritos a extraordinarios</span>
          {{-- NAVIGATION BAR--}}
