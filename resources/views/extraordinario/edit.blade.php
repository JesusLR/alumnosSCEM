...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['extraordinario.update', $extraordinario->id])) }}
        <div class="card ">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <select id="ubicacion_id" class="browser-default validate select2" required name="ubicacion_id" style="width: 100%;">
                             <option value="{{$extraordinario->materia->plan->programa->escuela->departamento->ubicacion->id}}">{{$extraordinario->materia->plan->programa->escuela->departamento->ubicacion->ubiNombre}}</option>
                        </select>
                    </div>
                    <div class="col s12 m6 l4">
                        {!! Form::label('departamento_id', 'Departamento *', array('class' => '')); !!}
                        <select id="departamento_id" class="browser-default validate select2" required name="departamento_id" style="width: 100%;">
                            <option value="{{$extraordinario->materia->plan->programa->escuela->departamento->id}}">
                                {{$extraordinario->materia->plan->programa->escuela->departamento->depClave}}
                                {{"-"}}
                                {{$extraordinario->materia->plan->programa->escuela->departamento->depNombre}}
                            </option>
                        </select>
                    </div>
                    <div class="col s12 m6 l4">
                        ...
                        <select id="escuela_id" class="browser-default validate select2" required name="escuela_id" style="width: 100%;">
                            <option value="{{$extraordinario->materia->plan->programa->escuela->id}}">{{$extraordinario->materia->plan->programa->escuela->escNombre}}</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <select id="programa_id" class="browser-default validate select2" required name="programa_id" style="width: 100%;">
                            <option value="{{$extraordinario->materia->plan->programa->id}}">{{$extraordinario->materia->plan->programa->progNombre}}</option>
                        </select>
                    </div>
                    <div class="col s12 m6 l4">
                        {!! Form::label('plan_id', 'Plan *', array('class' => '')); !!}
                        <select id="plan_id" class="browser-default validate select2" required name="plan_id" style="width: 100%;">
                            <option value="{{$extraordinario->materia->plan->id}}">{{$extraordinario->materia->plan->planClave}}</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <select id="gpoSemestre" class="browser-default validate select2" required name="gpoSemestre" style="width: 100%;">
                            <option value="{{$extraordinario->materia->matSemestre}}">{{$extraordinario->materia->matSemestre}}</option>
                        </select>
                    </div>
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                ...
                <div class="row">
                    <div class="col s12 m6">
                        ...
                        <select id="materia_id" class="browser-default validate select2" required name="materia_id" style="width: 100%;">
                            <option value="{{$extraordinario->materia->id}}">{{$extraordinario->materia->matClave}}-{{$extraordinario->materia->matNombre}}</option>
                        </select>
                    </div>
                    <div class="col s12 m6">
                    ...
                    <div class="col s12 m6">
                        ...
                        <select id="empleado_id" class="browser-default validate select2" required name="empleado_id" style="width: 100%;">
                            ...
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}" @if($extraordinario->empleado_id == $empleado->id) {{ 'selected' }} @endif>{{$empleado->id ." - ".$empleado->persona->perNombre ." ". $empleado->persona->perApellido1." ".$empleado->persona->perApellido2}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col s12 m6">
                        ...
                        <select id="empleado_sinodal_id" class="browser-default validate select2" name="empleado_sinodal_id" style="width: 100%;">
                            <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}" @if($extraordinario->empleadoSinodal != NULL && $extraordinario->empleadoSinodal->id == $empleado->id) {{ 'selected' }} @endif>
