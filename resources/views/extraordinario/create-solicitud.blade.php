...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'store.solicitud','target'=>"_blank", 'method' => 'POST']) !!}
        <div class="card ">
          ...
          <div class="card-action">
            {!! Form::button('<i class="material-icons left">save</i> Guardar', ['id'=>'extSaveButton','class' => 'btn-large waves-effect  darken-3','type' => 'submit', 'disabled']) !!}
          </div>
        </div>
      {!! Form::close() !!}
    </div>
