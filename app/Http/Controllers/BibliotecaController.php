...
class BibliotecaController extends Controller
{
    ...
    {
        $configEncuestaActiva = Portal_configuracion::where('pcClave', 'BIBLIOTECA_ALUMNO_ACTIVA')->first();
        $BIBLIOTECA_ALUMNO_ACTIVA = $configEncuestaActiva->pcEstado == 'A' ? true: false;
