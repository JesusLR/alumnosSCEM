    ...
    public function list($grupo_id)
    {
        ...
        return Datatables::of($cursos)
            ->addColumn('action', function($cursos)
            {
                    ...
                    */
                    $acciones = '<div class="row">
                    <a href="calificaciones/primerreporte/'.$cursos->inscrito_id.'/'.$cursos->personas_id.'/'
                        .$cursos->gpoGrado.'/'.$cursos->gpoClave.'" target="_blank" class="button button--icon js-button js-ripple-effect" title="1er Trimestre" >
                        <i class="material-icons">picture_as_pdf</i>
                    </a>
                    <a href="calificaciones/segundoreporte/'.$cursos->inscrito_id.'/'.$cursos->personas_id.'/'
                        .$cursos->gpoGrado.'/'.$cursos->gpoClave.'" target="_blank" class="button button--icon js-button js-ripple-effect" title="2do Trimestre" >
                        <i class="material-icons">picture_as_pdf</i>
                    </a>
                    </div>';
